...
const grass = preload("res://Prefabs/grama.tscn")
...
func grass_spawner(scene:Node3D):
	for i in range(randi_range(50,200)):
		var obj:Object = grass.instantiate()
		scene.add_child(obj, true)
		obj.position = generate_spwn_point(4)
